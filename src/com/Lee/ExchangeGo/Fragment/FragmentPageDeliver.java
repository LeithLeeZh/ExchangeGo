...
import com.Lee.ExchangeGo.PageGoodDeliver;
...
public class FragmentPageDeliver extends Fragment implements View.OnClickListener{
    ...
    private Button btn_newDeliver,btn_myDeliver;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        btn_newDeliver= (Button) getActivity().findViewById(R.id.new_deliver);
       // btn_myDeliver= (Button) getActivity().findViewById(R.id.my_deliver);
        btn_newDeliver.setOnClickListener(this);
        //btn_myDeliver.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.new_deliver:
                Intent intent=new Intent(this.getActivity(),PageGoodDeliver.class);
    ...
    *//* ͷ����� *//*
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (rootView == null)
        {
            rootView = inflater.inflate(R.layout.page_good_deliver, null);
        }
        // 缓存的rootView需要判断是否已经被加过parent，如果有parent需要从parent删除，要不然会发生这个rootview已经有parent的错误。
        ViewGroup parent = (ViewGroup) rootView.getParent();
        if (parent != null)
