...
public class FragmentPageShop extends Fragment{
    ...
    private TextView tv_tittle,tv_content,tv_price,tv_popurse;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
      ...
      /*  tv_tittle= (TextView) getActivity().findViewById(R.id.item_tv_tittle);
        ...
        //tv_popurse= (TextView) getActivity().findViewById(R.id.popurse);
        ...
        query.findObjects(getActivity(),new FindListener<UserGoods>() {
            ...
            public void onSuccess(List<UserGoods> userGoodses) {
                ...
                for(UserGoods u:userGoodses){
                    ...
                    //map.put("good_image",u.getGood_image());
                 ...
                 //   tv_popurse= (TextView) getActivity().findViewById(R.id.popurse);
                    if (u.getIsExchange()==true){
                        ...
                        map.put("want","想换:"+u.getGood_want());
                        list.add(0,map);
                    }
                    else if (u.getIsExchange()==false){
                        //tv_popurse.setText("价格:");
                    map.put("want","价格:"+u.getGood_price());
                        list.add(0,map);
                    }


                    //添加适配器
                    SimpleAdapter adapter=new SimpleAdapter(getActivity(),list,R.layout.list_item,new String[]{"tittle","content","nickname","want"},new int[]{R.id.item_tv_tittle,R.id.item_tv_content,R.id.list_item_username,R.id.list_item_purpose});
