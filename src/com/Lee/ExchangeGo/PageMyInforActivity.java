...
public class PageMyInforActivity extends Activity implements View.OnClickListener{
    private TextView username,tv_nickname,tv_qq,tv_phone,tv_address,tv_update,my_id;
    private LinearLayout layout_name,layout_sex,layout_phone,layout_address;
    private EditText et_name,et_qq,et_phone,et_address;
    ...
    private void init(){
        ...
        tv_qq= (TextView) findViewById(R.id.myinfor_qq);
        ...
        et_qq= (EditText) findViewById(R.id.myinfor_gone_et_qq);
    ...
    public void onClick(View v) {
        if (v==tv_update){
           ...
           Myuser user=Myuser.getCurrentUser(this,Myuser.class);
            ...
            user.setQq(et_qq.getText().toString());
